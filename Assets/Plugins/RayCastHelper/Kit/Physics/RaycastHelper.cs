		...
		private void _Init()
		{
			...
			switch (m_RayType)
			{
				case eRayType.Raycast: {
						m_PhysicRaycast = () =>
						{
							if (m_RayData.Raycast(transform.TransformPoint(m_LocalPosition), m_Direction, m_Distance, m_LayerMask, m_QueryTriggerInteraction))
							{
				...
				case eRayType.RaycastAll: {
						...
						m_PhysicRaycast = () =>
						{
							m_HittedCount = m_RayData.RaycastNonAlloc(transform.TransformPoint(m_LocalPosition), m_Direction, ref m_RaycastHits, m_Distance, m_LayerMask, m_QueryTriggerInteraction);
							for (int i = 0; i < m_HittedCount && i < m_RaycastHits.Length; i++)
				...
				case eRayType.SphereCast: {
						m_PhysicRaycast = () =>
						{
							if (m_SphereRayData.SphereCast(transform.TransformPoint(m_LocalPosition), m_Radius, m_Direction, m_Distance, m_LayerMask, m_QueryTriggerInteraction))
							{
				...
				case eRayType.SphereCastAll: {
						...
						m_PhysicRaycast = () =>
						{
							m_HittedCount = m_SphereRayData.SphereCastNonAlloc(transform.TransformPoint(m_LocalPosition), m_Radius, m_Direction, m_Distance, m_RaycastHits, m_LayerMask, m_QueryTriggerInteraction);
							for (int i = 0; i < m_HittedCount && i < m_RaycastHits.Length; i++)
								_TriggerHitEvent(m_RaycastHits[i].transform);
							return m_HittedCount > 0;
						};
				...
				case eRayType.BoxCast: {
						m_PhysicRaycast = () =>
						{
							if (m_BoxcastData.BoxCast(transform.TransformPoint(m_LocalPosition), m_HalfExtends, m_Direction, (m_UnSyncRotation) ? Quaternion.Euler(m_LocalRotation) : transform.rotation * Quaternion.Euler(m_LocalRotation), m_Distance, m_LayerMask, m_QueryTriggerInteraction))
							{
				...
				case eRayType.BoxCastAll: {
						...
						m_PhysicRaycast = () =>
						{
							m_HittedCount = m_BoxcastData.BoxCastNonAlloc(transform.TransformPoint(m_LocalPosition), m_HalfExtends, m_Direction, m_RaycastHits, (m_UnSyncRotation) ? Quaternion.Euler(m_LocalRotation) : transform.rotation * Quaternion.Euler(m_LocalRotation), m_Distance, m_LayerMask, m_QueryTriggerInteraction);
							for (int i = 0; i < m_HittedCount && i < m_RaycastHits.Length; i++)
								_TriggerHitEvent(m_RaycastHits[i].transform);
							return m_HittedCount > 0;
						};
				...
				case eRayType.CapsuleCast: {
						m_PhysicRaycast = () =>
						{
							if (m_CapsulecastData.CapsuleCast(
								transform.TransformPoint(m_LocalPoint1),
								transform.TransformPoint(m_LocalPoint2),
								m_Radius, m_Direction, m_Distance, m_LayerMask, m_QueryTriggerInteraction))
							{
				...
				case eRayType.CapsuleCastAll: {
						...
						m_PhysicRaycast = () =>
						{
							m_HittedCount = m_CapsulecastData.CapsuleCastNonAlloc(
								transform.TransformPoint(m_LocalPoint1),
								transform.TransformPoint(m_LocalPoint2),
								m_Radius, m_Direction, m_RaycastHits, m_Distance, m_LayerMask, m_QueryTriggerInteraction);
							for (int i = 0; i < m_HittedCount && i < m_RaycastHits.Length; i++)
								_TriggerHitEvent(m_RaycastHits[i].transform);
							return m_HittedCount > 0;
						};
